/*
Generic methods are a very efficient way to handle multiple data types using a single method. This
...
that can print all the elements of both arrays. The method should be able to accept both integer
